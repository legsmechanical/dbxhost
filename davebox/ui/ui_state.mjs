...
export const S = {
    ...
    masterPos: 0,
    daveWindowOn: null,  /* the Daves switch (global menu): true = a collected Dave scrolls through the session banner while playing; false = static wordmark. null = not yet read from the device-global pref file; DEFAULT OFF. */
